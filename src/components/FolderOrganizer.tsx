...
export default function FolderOrganizer({
  ...
  const isReady = connectedFolder && hasProfiles && !isProcessing;
    ...
    <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs flex flex-col gap-6" id="folder-organizer-section">
      <div>
        <h2 className="text-lg font-semibold text-slate-800 flex items-center gap-2">
          ...
          Organizador & Reconhecimento Facial
        </h2>
        <p className="text-xs text-slate-500 mt-1">
          Inicie o algoritmo de IA para verificar fotos e classificá-las de acordo com os perfis criados.
        </p>
      </div>
          ...
          >
            {isProcessing ? (
              ...
              <>
                ...
                Iniciar Organização Automática
              </>
            )}
          </button>
        </div>
